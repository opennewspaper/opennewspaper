<?php
/**
 *  \file class.tx_newspaper_articlelist_test.php
 * 
...
class tx_newspaper_ArticleList_Test extends tx_newspaper_ArticleList {
	...
	static protected $table = 'tx_newspaper_articlelist_test';	///< SQL table for persistence
}

tx_newspaper_ArticleList::registerArticleList(new tx_newspaper_ArticleList_Test());
