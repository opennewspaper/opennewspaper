...
if (t3BackendObject != top) {
    ...
    loadJsCssFile(t3BackendObject.path + "typo3conf/ext/newspaper/contrib/tabmanagement.js", "js");
    alert(t3BackendObject.path + "typo3conf/ext/newspaper/contrib/tabmanagement.js");    
}
