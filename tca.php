...
$TCA["tx_newspaper_article"] = array (
	...
	"interface" => array (
		"showRecordFieldList" => "hidden,starttime,endtime,articletype_id,publish_date,title,title_list,kicker,kicker_list,teaser,teaser_list,text,author,source_id,source_object,extras,sections,name,is_template,template_set,pagezonetype_id,inherits_from,workflow_status,modification_user,tags,related"
	),
...
$TCA["tx_newspaper_extra_articlelist"] = array (
	...
	"columns" => array (
		...
		"articlelist" => Array (		
			...
			"config" => Array (
				"type" => "select",	
				"foreign_table" => "tx_newspaper_articlelist",	
				"foreign_table_where" => "ORDER BY tx_newspaper_articlelist.uid",	
				"size" => 1,	
				"minitems" => 0,
				"maxitems" => 1,	
				"wizards" => Array(
					...
					"add" => Array(
						...
						"icon" => "add.gif",
						"params" => Array(
							"table"=>"tx_newspaper_articlelist",
							"pid" => "###CURRENT_PID###",
							"setValue" => "prepend"
						),
						"script" => "wizard_add.php",
