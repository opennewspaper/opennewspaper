...
try {
    ...
    $TCA["tx_newspaper_article"] = array (
        ...
        "types" => array (
            "0" => array("showitem" => "hidden;;1;;1-1-1, articletype_id, author, kicker_list, kicker, title_list, title;;;;2-2-2, teaser_list;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_newspaper/rte/], teaser;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_newspaper/rte/], bodytext;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_newspaper/rte/], no_rte, url, publish_date, modification_user, source_id, source_object, sections, is_template, extras, name, pagezonetype_id, template_set, inherits_from, tags, related, workflow_status")
        ),
        "palettes" => array (
            "1" => array("showitem" => "starttime, endtime")
        )
