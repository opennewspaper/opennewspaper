...
$TCA["tx_newspaper_article"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "hidden, starttime, endtime, articletype_id, title, kicker, teaser, text, author, source_id, source_object, extras, sections, name, is_template, template_set, pagezonetype_id, inherits_from, publish_date, workflow_status, modification_user",
	)
);
...
$TCA["tx_newspaper_extra_externallinks"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "template_set, pool, links",
	)
);
