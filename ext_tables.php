...
$TCA["tx_newspaper_extra_image"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "hidden, starttime, endtime, short_description, pool, title, image_file, credit, caption, normalized_filename, kicker, source, image_type, alttext, image_url, tags, template",
	)
);
...
$TCA["tx_newspaper_extra_textbox"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "starttime, endtime, short_description, pool, title, bodytext, image, template",
	)
);
