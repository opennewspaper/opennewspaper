...
$TCA["tx_newspaper_article"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "hidden, starttime, endtime, articletype_id, publish_date, title, title_list, kicker, kicker_list, teaser, teaser_list, text, author, source_id, source_object, extras, sections, name, is_template, template_set, pagezonetype_id, inherits_from, workflow_status, modification_user, tags, related",
	)
);
...
$TCA["tx_newspaper_tag"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "tag, tag_type",
	)
);
