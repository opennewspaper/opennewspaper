...
$TCA["tx_newspaper_extra_image"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "hidden, starttime, endtime, short_description, pool, title, image_file, credit, caption, normalized_filename, kicker, source, image_type, alttext, tags, template",
	)
);
