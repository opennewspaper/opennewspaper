...
//TODO colspan 7 -> make configurable
  $(json.id).update("<td colspan=\"7\"><iframe class=\"extra_iframe\" width=\"600\" height=\"549\" src=\"" + path + "typo3/alt_doc.php?returnUrl=" + path + "typo3conf/ext/extra/res/close_extra.html" + param + "&" + json.iframe_param + "\"></iframe></td>");
}
